...
class _HomeMenuState extends State<HomeMenu> {
  ...
  static const List<String> _tabTitles = ['Widgets', 'StatefullWidgets', 'Formularios', 'Servicios'];
  ...
  // Lista de la cuarta pestaña (Servicios)
  ListView _buildServicesList(BuildContext context) {
    return ListView(
      children: [
        ListTile(
          leading: const Icon(Icons.people),
          title: const Text('CRUD de Usuarios'),
          subtitle: const Text('Crear, leer, actualizar y eliminar usuarios (HTTP)'),
          onTap: () => _navigateTo(context, const UserCrudPage()),
        ),
        ListTile(
          leading: const Icon(Icons.email),
          title: const Text('Enviar Correo'),
          subtitle: const Text('Enviar correo electrónico con SMTP'),
          onTap: () => _navigateTo(context, const EmailPage()),
        ),
      ],
    );
  }
